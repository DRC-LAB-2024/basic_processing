void SetUpIO(){
  ...
  pinMode(ButtonEmer, INPUT_PULLUP);
  ...
  pinMode(AUTOMANUAL_MODE, INPUT_PULLUP);
  pinMode(MANUALPOS_ANL_MODE, INPUT_PULLUP);
...
void InitializePre(){
  PreStaMode = digitalRead(AUTOMANUAL_MODE);
  PreStaEmer = digitalRead(MANUALPOS_ANL_MODE);
  PreBtnStart = digitalRead(ButtonStart);
  PreBtnStop = digitalRead(ButtonStop);
  PreBtnEmer = digitalRead(ButtonEmer);
  delay(20);
  PreStaMode = digitalRead(AUTOMANUAL_MODE);
  PreStaEmer = digitalRead(MANUALPOS_ANL_MODE);
  PreBtnStart = digitalRead(ButtonStart);
