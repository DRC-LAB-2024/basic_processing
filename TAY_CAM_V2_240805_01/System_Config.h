...
#define ButtonStart 6 //3
#define ButtonStop  32 //32 //2
#define ButtonEmer  36 //4
#define ButtonMenu  33
...
#define AUTOMANUAL_MODE 38
#define MANUALPOS_ANL_MODE 39
#define MANUALMODE_ANGLE_SEND 4
#define MANUALMODE_POS_SEND 1
#define AUTOMODE_SINGLEPOINT_SEND 2
#define AUTOMODE_MULTIPLEPOINT_SEND 3
