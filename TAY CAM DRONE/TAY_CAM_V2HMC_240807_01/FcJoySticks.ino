...
//  long scalevalue = map(scale, 0, 1023, 50, 138);
  ...
  long scalevalue_2 = map(temp1, -54, 0, -scalevalue, 0);
...
//  Serial.print(" pitch212: "); Serial.println(scalevalue);
  long scalevalue_1 = map(temp1, 0, 60, 0, scalevalue);
//  Serial.print(" pitch212: "); Serial.println(scalevalue);
  long scalevalue_2 = map(temp1, -60, 0, -scalevalue, 0);
  if(temp1 >= 0) return ((float)scalevalue_1);
  if(temp1 < 0) return ((float)scalevalue_2);
  else return 0;
}
...
//  long scalevalue = map(scale, 0, 1023, 40, 180);
  ...
  long scalevalue_1 = map(temp1, 0, 108, 0, scalevalue);
  long scalevalue_2 = map(temp1, -115, 0, -scalevalue, 0);
  if(temp1 >= 0) return ((float)scalevalue_1);
  if(temp1 < 0) return ((float)scalevalue_2);
  else return 0;
}
...
//  long scalevalue = map(scale, 0, 1023, 100, 5000);
  ...
  long scalevalue_1 = map(temp1, 0, 56, 0, scalevalue);
