...
bool LedModeStatus(uint8_t BtMode_in, bool ledMode_in, int Led_IN){
  ...
  */
  ...
  long cTemp = millis();
  if (abs(cTemp - CurrentTimeMode) >= 100)
  {
...
//       Serial.print("BtMode_in single: "); Serial.println(BtMode_in);
//        Serial.print("ledMode_out: "); Serial.println(ledMode_out);
//      }
    }
    CurrentTimeMode = cTemp;
