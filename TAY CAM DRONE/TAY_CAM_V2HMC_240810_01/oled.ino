...
--------------------------------------*/
void Menu_oled1(bool pumpstatus, long pumpFlow)
{
  display.clearDisplay(); 
  display.setTextSize(1);
  //------ HIEN THI CAC THONG TIN KHAC--------
  display.setCursor(0, 0);  // (x,y)
  display.print("Others Info:");

  //------ HIEN THI TRANG THAI PUMP--------
  display.setCursor(0, 16);
  display.print("PUMP:");
  display.setCursor(36, 16);
  if(pumpstatus)
  ...
  //------ HIEN THI LUU LUONG PUMP--------
  display.setCursor(0, 32);
  display.print("PFlow:");
  display.setCursor(36, 32);
  display.print(pumpFlow);
  //------ HIEN THI ....--------
  display.setCursor(0, 48);
  display.print(".......");
//  display.setCursor(36, 48);
